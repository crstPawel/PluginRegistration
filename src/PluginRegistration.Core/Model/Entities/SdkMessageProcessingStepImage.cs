...
namespace PluginRegistration.Core.Model.Entities
{
	...
	public partial class SdkMessageProcessingStepImage : Microsoft.Xrm.Sdk.Entity
	{
		...
		/// <summary>
		/// Available fields, at the time of codegen, for the sdkmessageprocessingstepimage entity
		/// </summary>
		...
		public virtual Microsoft.Xrm.Sdk.OptionSetValue ImageType
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
            ...
            foreach (var p in anonymousType.GetType().GetProperties())
            {
                ...
                switch (name)
                {
                    case "id":
                        ...
                        this.Attributes["sdkmessageprocessingstepimageid"] = base.Id;
                        break;
