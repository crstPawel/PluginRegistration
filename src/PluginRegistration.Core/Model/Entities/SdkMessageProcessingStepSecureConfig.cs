...
namespace PluginRegistration.Core.Model.Entities
{
	...
	public partial class SdkMessageProcessingStepSecureConfig : Microsoft.Xrm.Sdk.Entity
	{
		...
		/// <summary>
		/// Available fields, at the time of codegen, for the sdkmessageprocessingstepsecureconfig entity
		/// </summary>
            ...
            foreach (var p in anonymousType.GetType().GetProperties())
            {
                ...
                switch (name)
                {
                    case "id":
                        ...
                        this.Attributes["sdkmessageprocessingstepsecureconfigid"] = base.Id;
                        break;
